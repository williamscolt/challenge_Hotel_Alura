...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		btnexit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				int result = JOptionPane.showConfirmDialog(null, "Desea cerrar la aplicación?");
	    ...
	    String textoDescripcion1 = "<html><body>  Herramienta que le permitirá llevar un control completo y detallado de sus reservas y huéspedes, tendrá acceso a heramientas especiales para tareas específicas como lo son:</body></html>";
