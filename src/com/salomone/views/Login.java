...
public class Login extends JFrame {
	...
	private void login() {
	    ...
	    if (esUsuarioValido(nombreUsuarioIngresado, contraseñaIngresada)) {
	...
	private boolean esUsuarioValido(String nombreUsuario, String contraseña) {
	    ...
	    for (String[] usuario : usuariosFijos) {
