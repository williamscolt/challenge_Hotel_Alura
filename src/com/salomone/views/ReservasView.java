...
import com.salomone.controller.ReservasController;
import com.salomone.modelo.Reserva;
...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int result = JOptionPane.showConfirmDialog(null, "Desea cerrar el Sistema de Reservas?");
				if(result == JOptionPane.OK_OPTION) {
				
					JOptionPane.showMessageDialog(null, "Se está dirigiendo al Menú Principal!");
	...
	private void guardarReserva() {	
		...
		JOptionPane.showMessageDialog(null,"Reserva Guardada con éxito, id: " + nuevaReserva.getId());
